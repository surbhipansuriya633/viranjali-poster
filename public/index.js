...
function loadImage(imageSrc) {
  ...
  img.onload = function () {
      ...
      ctx.drawImage(img, 622, 480, 340, 339);
...
function renderText() {
  ...
  ctx.drawImage(uploadedImage,  622, 480, 340, 339);
...
if(textInput.length <= 7){
  const textX = 802; // X coordinate
  const textY = 1250; // Y coordinate
...
function downloadImage() {
  ...
  a.href = dataURL;
  a.download = "Blood-donate-image.png";
